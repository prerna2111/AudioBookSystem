Using a linked list data structure,an audiobook library system has been made using C language where a user list and audiobook list have to be maintained. 
